  ...
  async start() {
    try {
      ...
      /*Swal.fire({
        icon: 'error',
        title: 'Restart...',
        html: 'Detected Error!..' + error,// + br + '• Kullanıcı Reddedildi sorununu azaltmak için İşlemi Düzenle.' + br + '• CAPTCHA sayfası iptal süresini 70 saniyeye düşürün. ' + br + '• Otomatik Tıklamayı Güncelle v.1.1 ',
        showConfirmButton: false,
        timer: 2500
      })*/
