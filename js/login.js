    ...
    async detectError() {
        ...
        if (errChecking == match) {
            Swal.fire({
                icon: 'error',
                title: 'Restart...',
                html: 'Detected Error! Get Time Mining',// + br + '• Kullanıcı Reddedildi sorununu azaltmak için İşlemi Düzenle.' + br + '• CAPTCHA sayfası iptal süresini 70 saniyeye düşürün. ' + br + '• Otomatik Tıklamayı Güncelle v.1.1 ',
                showConfirmButton: false,
                timer: 2500
            })
            setTimeout(function () {
